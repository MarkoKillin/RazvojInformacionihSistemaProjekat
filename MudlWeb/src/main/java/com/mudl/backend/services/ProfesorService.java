...
public class ProfesorService {
	...
	public List<Zadatakkorisnik> getResenja(int idPredmet) {
		return zkr.getResenja(idPredmet);
	}

	public Zadatakkorisnik getResenje(int idZadatakKorisnik) {
		return zkr.findById(idZadatakKorisnik).get();
	}
