...
<body>
	...
	<nav> 
		...
		<a href="/Mudl/student/getAddToPredmet"><button style="margin-bottom: 15px;">Dodaj kurs</button></a>
		<a href="/Mudl/student/getUpdateProfile"><button style="margin-bottom: 15px;">Uredi Profil</button></a>
